...
export const getSingleTour = async (req, res) => {
    ...
    try {
        ...
        res.status(200).json({success: true, message: "Tour got successfully", data: tour});
...
export const getAllTour = async (req, res) => {
    ...
    try {
        ...
        res.status(200).json({success: true, count:tours.length, message: "Tours got successfully", data: tours});
...
export const getTourBySearch = async (req, res) => {
    ...
    const city = new RegExp(req.query.city, 'i'); // here i means case insensitive
